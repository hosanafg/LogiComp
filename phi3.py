...
def analisar_lotes():
    ...
    # Garante a existência de todas as pastas de saída
    ...
    for i_arquivo in range(1, total_arquivos + 1):
        ...
        with open(caminho_entrada, mode='r', encoding='utf-8') as f_in:
            ...
            for table_row in leitor:
                ...
                try:
                    # Execução do teste estruturado (Tuplas)
                    ...
                    print(f"--> Linha {rodada:02d} | T:{n:02d} | C:{qtd_conexoes:02d} | Z3={gabarito_z3} | Tuplas={pred_estruturado} ({status_est}) | Natural={pred_natural} ({status_nat})")
        ...
        # Gravando as predições do Phi-3 e gabaritos
